...
- Harmonisation de `SeniorCitizen` : `0/1` déjà correct
...
> Les relations étant quasi-linéaires, la LR est aussi performante que XGBoost.

### Étape 6 — Optimisation du seuil
Le seuil par défaut (0.50) a été abaissé à **0.45** pour maximiser le recall :
...
4 segments définis selon la probabilité de churn :
...
### 1. Cloner le repo
```bash
git clone https://github.com/votre-username/telco-churn-prediction.git
